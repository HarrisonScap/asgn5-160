...
#define LOW_PRECISION`),e}function Xp(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===nc?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Jc?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===sn&&(e="SHADOWMAP_TYPE_VSM"),e}function qp(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case pi:case mi:e="ENVMAP_TYPE_CUBE";break;case Ls:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Yp(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case mi:e="ENVMAP_MODE_REFRACTION";break}return e}function jp(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Or:e="ENVMAP_BLENDING_MULTIPLY";break;case Tl:e="ENVMAP_BLENDING_MIX";break;case Al:e="ENVMAP_BLENDING_ADD";break}return e}function Kp(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function $p(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Xp(t),l=qp(t),h=Yp(t),u=jp(t),d=Kp(t),m=Op(t),g=Bp(r),_=i.createProgram();let p,f,E=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const M=E+p+a,T=E+f+o,L=Eo(i,i.VERTEX_SHADER,M),R=Eo(i,i.FRAGMENT_SHADER,T);i.attachShader(_,L),i.attachShader(_,R),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(N){if(s.debug.checkShaderErrors){const H=i.getProgramInfoLog(_).trim(),C=i.getShaderInfoLog(L).trim(),G=i.getShaderInfoLog(R).trim();let W=!0,j=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(W=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,L,R);else{const $=To(i,L,"vertex"),V=To(i,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
